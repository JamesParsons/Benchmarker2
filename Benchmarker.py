...
def show_graph():
    ...
    #graph_window['bg'] = ['white']
    #graph_window.title("Graphed Results")  
    
    #img = PhotoImage(file='C:\Users\wedel\OneDrive\Desktop\HomelessGraph.png')
    img = PhotoImage(file='C:\\Users\\wedel\\OneDrive\\Desktop\\HomelessGraph.png')
    Label(graph_window.base,image=img).pack() 
    
    #Button(graph_window.base, text="Buy Graphical Version For $299 A Month", command=buy_graphical(), bd="8p").pack()
    #Button(graph_window.base, text="Stick With Non-Graphical Version for Free!", command=buy_graphical(), bd="8p").pack()
